          ...
          <div className="p-6 bg-white rounded-t-lg">
            <div className="flex flex-col items-center justify-center mb-6 text-center">
              <div className="w-16 h-16 rounded-full bg-red-400/10 flex items-center justify-center mb-4">
                <FaX className="w-8 h-8 text-red-900" />
              </div>
              <h2 className="text-2xl font-bold text-[#4D4D4D] mb-2">การจองนี้ถูกยกเลิก</h2>
              <p className="text-gray-500 max-w-xs">
                การจองนี้ถูกยกเลิกจากทางร้าน ขออภัยในความไม่สะดวก
              </p>
              <p className="text-gray-500 max-w-xs">
              ขออภัยในความไม่สะดวก หากต้องการจองใหม่ กรุณาติดต่อทางร้านอีกครั้ง
              </p>
            </div>
