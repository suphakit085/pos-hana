    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 flex flex-col items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-4">รายละเอียดการจอง</h1>
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 py-3 bg-[#FFB8DA] hover:bg-pink-400 text-white rounded-lg font-medium transition-colors"
            >
              กลับสู่หน้าหลัก
            </button>
            <button
